...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","LYH_SQL","PASSWD"}, \
				{0,-1,"","LYH_UBT","PASSWD"},  {0,-1,"","LYH_ARD","PASSWD"}, \
				{0,-1,"","LYH_AND","PASSWD"},  {0,-1,"","LYH_LIN","PASSWD"}, \
				{0,-1,"","LYH_BT","PASSWD"},  {0,-1,"","YKG_BT","PASSWD"}, \
...
void send_msg(MSG_INFO * msg_info, CLIENT_INFO * first_client_info)
{
	...
	else if (!strcmp(msg_info->from, "LYH_ARD")) {
